    ...
    return (
        <div className="product-details" ref={ ref }>
            ...
            <div className="product-details-action">
                <a
                    href="#"
                    className={ `btn-product btn-cart ${( !canAddToCart( props.cartlist, product, qty ) || ( product[0].variants.length > 0 && !showVariationPrice ) ) ? 'btn-disabled' : ''}` }
            ...
            <div className="product-details-footer">
                <div className="product-cat w-100 text-truncate">
                    <span>Category:</span>
                    {
                        product[0].category.map( ( cat, index ) => (
                            <span key={ index }>
                                <ALink
                        ...
                        <div className="col-6">
                            <figure className="product-media">
                                <ALink href={ `/product/default/${product.slug}` }>
                                    <img src={ process.env.NEXT_PUBLIC_ASSET_URI + product[0].pictures[ 0 ].url } alt="product" width={ product[0].pictures[ 0 ].width } height={ product[0].pictures[ 0 ].height } />
                                </ALink>
                            </figure>
